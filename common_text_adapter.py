...
class ResidualAttentionBlock(nn.Module):
    def __init__(self, d_model: int, n_head: int, attn_mask: torch.Tensor = None):
        ...
        #print(att.shape) torch.Size([8, 1024, 512])
        self.Space_Adapter = Adapter(512)  # with skip connection
        #print(self.ln_2(tokens).shape) torch.Size([13, 11, 512])
        self.MLP_Adapter = Adapter(512, skip_connect=False)  # MLP-adapter, no skip connection
        self.scale = 0.5
